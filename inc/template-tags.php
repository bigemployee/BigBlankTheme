...
if (!function_exists('bigblank_posted_on')) :
    ...
    function bigblank_posted_on() {
        ...
        printf('<span class="entry-date"><a href="%1$s" rel="bookmark"><time class="published" datetime="%2$s">%3$s</time></a></span> <span class="byline"><span class="author vcard"><a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span>', esc_url(get_permalink()), esc_attr(get_the_date('c')), esc_html(get_the_date()), esc_url(get_author_posts_url(get_the_author_meta('ID'))), get_the_author()
        );
    }
